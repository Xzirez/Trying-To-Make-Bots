...
chromedriver_path = '/Users/vetle/Downloads/chromedriver' # Change this to your own chromedriver path!
...
username.send_keys('fitnessforcoder')
password = webdriver.find_element_by_name('password')
password.send_keys('12356123qWl12356')
...
for hashtag in hashtag_list:
    ...
    try:
        for x in range(1,200):
                ...
                print(username)
                if webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div/header/div[2]/div[1]/div[2]').text == 'Follow':
